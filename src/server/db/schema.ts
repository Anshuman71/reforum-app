...
export const roles = pgTable(
  ...
  (t) => [uniqueIndex("idx_roles_name_unique").on(t.name)],
);
...
export const categoryRoles = pgTable(
  "category_roles",
  {
    id: text("id").primaryKey(),
    categoryId: text("category_id")
  ...
  (t) => [
    index("idx_category_roles_category").on(t.categoryId),
    index("idx_category_roles_role").on(t.roleId),
    uniqueIndex("idx_category_roles_unique").on(t.categoryId, t.roleId),
  ],
);
...
export const postRevisions = pgTable(
  ...
  (t) => [
    index("idx_post_revisions_post").on(t.postId),
    index("idx_post_revisions_editor").on(t.editorUserId),
  ],
);
...
export const commentRevisions = pgTable(
  ...
  (t) => [
    index("idx_comment_revisions_comment").on(t.commentId),
    index("idx_comment_revisions_editor").on(t.editorUserId),
  ],
);
...
export type PostRevisionInsert = typeof postRevisions.$inferInsert;
export type PostRevisionSelect = typeof postRevisions.$inferSelect;
export type CommentRevisionInsert = typeof commentRevisions.$inferInsert;
export type CommentRevisionSelect = typeof commentRevisions.$inferSelect;
...
export const usersRelations = relations(users, ({ one, many }) => ({
  ...
  commentRevisions: many(commentRevisions),
}));

export const rolesRelations = relations(roles, ({ many }) => ({
  permissions: many(rolePermissions),
  categoryRoles: many(categoryRoles),
}));
...
export const categoryRolesRelations = relations(categoryRoles, ({ one }) => ({
  category: one(categories, {
    fields: [categoryRoles.categoryId],
    references: [categories.id],
  }),
  role: one(roles, {
    fields: [categoryRoles.roleId],
    references: [roles.id],
  }),
}));
...
export const postRevisionsRelations = relations(postRevisions, ({ one }) => ({
  ...
  editor: one(users, {
    fields: [postRevisions.editorUserId],
    references: [users.id],
  }),
}));
...
export const commentRevisionsRelations = relations(
  ...
  ({ one }) => ({
    comment: one(comments, {
      fields: [commentRevisions.commentId],
      references: [comments.id],
    }),
    editor: one(users, {
      fields: [commentRevisions.editorUserId],
      references: [users.id],
    }),
  }),
);
